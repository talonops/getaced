...
func Routes(app *fiber.App) {
	...
	// Onboarding
	v1.Post("/onboarding/watch-folder", middleware.AuthRequired, handler.SetOnboardingWatchFolder)
	v1.Post("/onboarding/session", middleware.AuthRequired, handler.CreateSetupSession)
	v1.Post("/onboarding/session/complete", middleware.AuthRequired, handler.CompleteSession)
	...
	v1.Get("/activity", middleware.AuthRequired, handler.GetActivity)
